...
public class TestSearchAlgorithmWithHashmapAndNotEnteredSortAlgorithm {
    ...
    @Test
    @DisplayName("SearchNodeV1-Null-SearchNode")
    @Order(1)
    public void test_Manuel_SearchNodeV1_Null_HashmapSearch() {
        testAlgorithmResult = buildTestAlgorithmResult(EnumDataStructor.SEARCHNODE_V1, null, EnumSearchAlgorithm.SEARCH_NODE);
