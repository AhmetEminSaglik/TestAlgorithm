package org.ahmeteminsaglik.hashmap;
...
public class TestSearchAlgorithmWithHashmapAndNoSort {
    ...
    @Test
    @DisplayName("Hashmap-NoSort-HashmapSearch")
    @Order(1)
    public void test_Manuel_Hashmap_NoSort_HashmapSearch() {
        testAlgorithmResult = buildTestAlgorithmResult(EnumDataStructor.HASHMAP, EnumSortAlgorithm.NO_SORT, EnumSearchAlgorithm.HASHMAP);
