...
public class SABreadthFirstSearch extends BaseSearchAlgorithmComplexityCalculation implements BaseSearchAlgorithmFunction {
    public SABreadthFirstSearch(TestAlgorithmResult testAlgorithmResult) {
