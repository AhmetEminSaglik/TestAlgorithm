...
public class SAInterpolationSearch extends BaseSearchAlgorithmComplexityCalculation implements BaseSearchAlgorithmFunction {
    public SAInterpolationSearch(TestAlgorithmResult testAlgorithmResult) {
