...
public class SAJumpSearch extends BaseSearchAlgorithmComplexityCalculation implements BaseSearchAlgorithmFunction {
    public SAJumpSearch(TestAlgorithmResult testAlgorithmResult) {
