...
public class SAFibonacciSearch extends BaseSearchAlgorithmComplexityCalculation implements BaseSearchAlgorithmFunction {
    public SAFibonacciSearch(TestAlgorithmResult testAlgorithmResult) {
