package org.ahmeteminsaglik.core.solution;

public class SolutionForException {
    public final static String getSortAlgorithmInstructorWithSuitableDataStructor() {
